...
SELECT PERSON_TYPE AS "PERSON GROUP",
  REPLACE(REPLACE(REPLACE(ACTIVITY_PATTERN, 'Mandatory' collate Latin1_General_CS_AS ,'Mandatory'),
  'Home' collate Latin1_General_CS_AS, 'Home'),
  'Non-Mandatory' collate Latin1_General_CS_AS, 'Non-mandatory') AS "DAY PATTERN", 
